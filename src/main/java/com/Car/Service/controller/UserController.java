...
import com.Car.Service.validator.UserValidator;
...
public class UserController {
	 ...
	 */
    @RequestMapping(value = "/registration/{name}/{pas}", method = RequestMethod.POST)
    public void registration(@ModelAttribute("userForm") User userForm, BindingResult bindingResult, Model model) {
